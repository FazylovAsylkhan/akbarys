...
const VerificationLaboratoryDescription: FC<LaboratoryDescriptionProps> = ({ content }) => {
  const {
    title, description, subtitle, items, texts,
  } = content;
      ...
      <div className="verificationLaboratoryDescription">
        <div className="container">
          <div className="verificationLaboratoryDescription__wrapper">
            <h2 className="verificationLaboratoryDescription__title title-1 left black">
              {title}
            </h2>
